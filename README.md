...
| `get_krav_for_gjennomgang` | Forbered interaktiv gjennomgang med synlig kravhensikt, suksesskriteriers id/navn/behovForBegrunnelse (uten SK-beskrivelse — hentes ett SK om gangen via `begin_sk_review`) og eventuell eksisterende besvarelse |
